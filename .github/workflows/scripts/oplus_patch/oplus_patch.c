...
* branch oneplus/sm8850_b_16.0.0_oneplus_15, path vendor/oplus/kernel/patch/.
* Verbatim. Kprobe/kretprobe runtime hook framework driven through procfs -
* no other OPlus dependency, needs only CONFIG_KPROBES (on in stock GKI).
*/
