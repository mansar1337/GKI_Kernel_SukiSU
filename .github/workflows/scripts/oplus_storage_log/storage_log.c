 ...
 * vendor/oplus/kernel/storage/storage_feature_in_module/common/storage_log/.
 * Verbatim. In-memory storage log + pr_storage() backend consumed by
 * oplus_uprobe - always vendored together under --oplus-uprobe.
 */
