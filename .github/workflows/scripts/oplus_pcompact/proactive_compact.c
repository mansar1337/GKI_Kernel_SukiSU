 ...
 * Verbatim (Kconfig/Makefile are project-created: upstream builds this file
 * unconditionally via Bazel). Procfs-driven proactive compaction, no other
 * OPlus dependency.
 */
...
static unsigned int fragmentation_score_wmark(void)
{
