 ...
 * branch oneplus/sm8550_v_15.0.0_oneplus11, path vendor/oplus/kernel/mm/async_reclaim_opt/abort_mm_opt/.
 * Verbatim. Abort pointless madvise/compact via mm vendor hooks.
 */
