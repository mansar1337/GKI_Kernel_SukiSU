 ...
 * branch oneplus/sm8550_v_15.0.0_oneplus11, path vendor/oplus/kernel/mm/memload_opt/mapped_protect/.
 * Verbatim. Mapped-file reclaim protection via mm vendor hooks.
 * (level_protect.c/h are only built under CONFIG_OPLUS_SMART_STORAGE,
 * which we do not define - copied for completeness.)
 */
